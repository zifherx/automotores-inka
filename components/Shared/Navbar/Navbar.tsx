    ...
    <nav className="bg-[#F8F8F8] w-full">
      <div className="h-20 flex items-center justify-between p-4 mx-auto sm:max-w-4xl md:max-w-7xl">
        ...
        <div className="hidden sm:flex items-center justify-between gap-2 sm:gap-5">
          <Link
            href="/new-cotizacion"
            className="flex items-center gap-3 rounded-md text-lg px-4 py-2 bg-black text-white hover:bg-white hover:text-black hover:border-2 hover:border-black transition-all"
          >
            Cotiza aquí
